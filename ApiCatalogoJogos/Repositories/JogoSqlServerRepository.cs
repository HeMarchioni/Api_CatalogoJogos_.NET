...
namespace ApiCatalogoJogos.Repositories
{
    ...
    {
        private readonly SqlConnection sqlConnection;  // -> pacote do Nuget Sistem data SqlCliente

        public JogoSqlServerRepository(IConfiguration configuration)  //-> Iconfiguration pega as Informaçoes do apppSettings (nesse caso Get.ConnectionString)
        {
